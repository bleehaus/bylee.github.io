...
(function(e){var f=function(){function b(){}b.COMMAND_ATTACH="ccv:attach";b.COMMAND_SETPOSTER="ccv:setposter";b.COMMAND_SETLOCALE="ccv:setlocale";b.DEFAULT_FAST_FORWARD=20;b.DEFAULT_FAST_BACKWARD=20;b.DEFAULT_SPINNER_WIDTH=32;b.DEFAULT_SPINNER_HEIGHT=32;b.DEFAULT_HOST="http://www.ccv.adobe.com";b.WWW_API_MANIFEST_ENDPOINT="/v1/player/api/ManifestProxy";b.WWW_PROXY_PLAYBACK_QUERY="playbackURI";b.WWW_PROXY_TOKEN_QUERY="token";b.WWW_GATEWAY_API_KEY_QUERY="api_key";b.EMBED_URL_EXP="^/v1/player/(.*)/embed$";
b.API_ROOT="/v1/player/";b.CONVERSION_INFO_QUERY="/info";b.BRIGHTCOVE_PLAYER_SELECTOR="#brightcovePlayer";b.STATUS_OK="ok";b.STATUS_GEN_POSTER="generating_poster";b.STATUS_GEN_PLAYLIST="generating_playlist";b.STATUS_ERROR="error";b.STATUS_INVALID="invalid";b.STATUS_REMOVED="removed";b.STATUS_BAD_ASSET="badasset";b.HELPER_NAME="com$adobe$ccv$brightcove";b.BAD_PARAMS_CODE=400;b.INVALID_ID_CODE=404;b.CONFLICT_CODE=409;b.GATEWAY_TIMEOUT_CODE=504;b.BAD_GATEWAY_CODE=502;b.REASON_HEADER_KEY="reason";b.BAD_ASSET_REASON=
"BAD_ASSET";b.PROCESSING_REASON="PROCESSING";b.REMOVED_REASON="REMOVED";b.DEFAULT_SETTINGS_JSON="json/default/config.json";b.DEFAULT_STRINGS_JSON="json/default/en.json";b.WWW_SERVICE_POLL_WAIT=5E3;b.BRIGHTCOVE_PLUGIN_NAME="BCHelperPlugin";b.TAG_SOURCE="source";b.ATTRIBUTE_SRC="src";b.ATTRIBUTE_TYPE="type";b.VIDEOJS_ID="video-js";b.APPLICATION_MPEG_URL="application/x-mpegURL";b.ENV_DEV="dev";b.ENV_PROD="prod";b.ENV_STAGE="stage";return b}();e.Constants=f})(com$adobe$ccv$app||(com$adobe$ccv$app={}));
...
$.proxy(this.hideLoader,this));this.playPauseControl.acceptsReplay()&&this.playPauseControl.showPauseState();LOGGING&&Log.info(this._LOGTAG,"_seek to "+a+", enabling onVideoTimeUpdate and onVideoProgress")};c.prototype._onKeyDown=function(a){var b=a.keyCode,c=this;if(32==b||39==b||37==b||13==b)a.stopImmediatePropagation(),a.preventDefault(),a.stopPropagation(),LOGGING&&Log.info(this._LOGTAG,"_onKeyDown: "+b),32==b||13==b?this._onPlayPauseVideoContainer(a):39==b?(this.progressControl.focusTimelineWrap(),
this.videoPlayer.getCurrentTime(function(a){a+=com$adobe$ccv$app.Constants.DEFAULT_FAST_FORWARD;var b=c.durationControl.getDuration();a>b&&0.5>a-b&&(a=b);a<=b&&(c._seek(a),c.showControls())})):37==b&&(this.progressControl.focusTimelineWrap(),this.videoPlayer.getCurrentTime(function(a){a-=com$adobe$ccv$app.Constants.DEFAULT_FAST_FORWARD;0>a&&(a=0);c._seek(a);c.showControls()}));else if(9==b&&this.screenControl._isFullScreen()){a.stopImmediatePropagation();a.preventDefault();a.stopPropagation();this.focusableElements.forEach(function(a){return a.classList.add("keyboardfocus")});
var b=this.focusableElements.indexOf(a.target),d=void 0,d=-1!=b?a.shiftKey?0===b?this.focusableElements.length-1:b-1:b===this.focusableElements.length-1?0:b+1:0;a=this.focusableElements[d];c.showControls();a.focus()}else 9==b&&(this.focusableElements.forEach(function(a){return a.classList.add("keyboardfocus")}),c.showControls())};c.prototype.setupSelectors=function(){var a=this,b=this.$el;this.videoHolder=b.find("#html5-video-holder");this._videoJSElement=b.find("#video-js");this._$fullScreenElement=
this.videoHolder;DOMUtil.isIOSDevice()?this._$fullScreenElement=this.videoHolder.find("video"):this._$fullScreenElement=this.videoHolder;this._videoHolder=this.videoHolder.get(0);this.controlbarHolder=b.find("#videocontrols");this._$progressHolderNew=b.find(".timelinewrap");this._$volumeHolderNew=b.find(".volumecontrols");this.spinner=b.find("#spinner");this._videoSurface=this.videoHolder.find("#video-surface");this._loadingSpinner=this._videoSurface.find(".spinnerwrap");var c=-1E3,d=-1E3;b.find("#video-surface").on("mouseenter",
...
'<div class="videogradient"></div><div class="timelinewrap"><div class="timelineknob"><div class="timeknob"></div></div><div class="duration"> 0.00 </div><div class="videotimewrap" tabindex="5" aria-label="timeline slider"><input class="timelineslide" type="range" tabindex="-1"  min="0" max="1" step="0.0001" aria-label="timeline"><div class="timeline" style="width:0%;"></div><div class="buffer" style="left: 0px; right: 0%;"></div><div class="track"></div><div class="hoverline dark"></div></div></div><div class="controlsleft"><button class="playpause videobutton playicon" tabindex="1">play</button><div class="videotime"><span class="timelabel">0:00</span><span class="vduration"></span></div></div><div class="controlsright"><div class="volumecontrols"><button class="videobutton mute level2 muteicon" tabindex="3">mute</button><span class="standard volumewrap"><div class="slidelabel" style="display:none;"><span class="sll">Volume</span><span class="slr volumelevel">0</span></div><div style="position:relative;z-index:1;height:100%;"><input type="range" class="slider volume" tabindex="2" max="100" aria-label="volume slider control"></div></span><div class="volumeslide" tabindex="-1" aria-label="volume slider"><div class="volumetracks"><div class="volumetrack"></div><div class="volumefill" style="width: 0%;"></div></div><div class="volumeknob" style="transform: translateX(-48px);"><div class="volumeknobfill"></div></div></div></div><button class="videobutton fullscreen" tabindex="4">fullscreen</button></div>')};
...
!1);var l=!1;videojs(f.get(0),x).ready(function(){function a(){LOGGING&&Log.info(d._LOGTAG,"*** handleFirstPlay");k||(LOGGING&&Log.info(d._LOGTAG,"*** handleFirstPlay: setTimeout()"),k=window.setTimeout(function(){clearTimeout(k);k=0;f.off(VideoJSEvents.PLAY,a);c.onFirstPlay()},50))}function b(){LOGGING&&Log.info(d._LOGTAG,"*** handleFirstPause");k&&(clearTimeout(k),k=0,LOGGING&&Log.info(d._LOGTAG,"*** handleFirstPause: clearTimeout(playTimer);"));f.off(VideoJSEvents.PAUSE,b)}l=!0;c.hideErrors();
var f=this,h=c.createCloudPlayer();c._player=f;c._cloudPlayer=h;h.setVideoJSPlayer(f);h.registerLoggerOnTimeUpdate(com$adobe$ccv$app.RenditionLogger.getInstance());h.attachTo(c.element,c.config,"","",c.videoWidth,c.videoHeight,e);var k=0;f.on(VideoJSEvents.PLAY,a);f.on(VideoJSEvents.PAUSE,b)});l||setTimeout(function(){if(!l){var a=null;DOMUtil.isAndroid()||DOMUtil.isIOSDevice()||(a=com$adobe$ccv$app.ErrorMessages.getInstance(e).getFlashPlayerMsg());c.showError(a)}},3E3)}};d.prototype.createPlayer=
function(a){function b(a,d){var f=c.getTechOrder(a,d);c._createPlayerForElement(a,f);e.resolve(c)}var c=this,e=$.Deferred(),f;(f=this.getWWWHost(a))&&f.length&&(f=this.getOriginFromUrl(f)+this.getPathFromUrl(f)+"/info"+this.getQueryFromUrl(f));a.find("video").attr("display","block");window.ccv$serverData&&window.ccv$serverData.minframeHeight&&window.ccv$serverData.minframeWidth&&window.ccv$serverData.duration?(c.config.setConfigValue("minframeWidth",window.ccv$serverData.minframeWidth.toString()),
c.config.setConfigValue("minframeHeight",window.ccv$serverData.minframeHeight.toString()),b(a,window.ccv$serverData.duration)):f?this.getAuthorizedJSON(f).then(function(d){c.config.setConfigValue("minframeWidth",d.minframe.width.toString());c.config.setConfigValue("minframeHeight",d.minframe.height.toString());b(a,d.duration)}).fail(function(){LOGGING&&Log.error(d._LOGTAG,"Failed to retrieve info"+f);e.reject()}):b(a,this.getDuration(a));return e.promise()};d.prototype.getWWWHost=function(a){return a.find("video").first().data("wwwhost")};
d.prototype.getOriginFromUrl=function(a){return(new URL(a)).origin};d.prototype.getPathFromUrl=function(a){return(new URL(a)).pathname};d.prototype.getQueryFromUrl=function(a){return(new URL(a)).search};d.prototype.getGatewayApiKeyFromUrlQueryParams=function(b){var c="";if(b&&b.includes(a.WWW_GATEWAY_API_KEY_QUERY)){b=b.substring(b.indexOf("?")+1);var d="",e=0;for(b=b.split("&");e<b.length;e++)if(d=b[e],d=d.split("="),1<d.length&&d[0]===a.WWW_GATEWAY_API_KEY_QUERY){c=d[1];break}}return c};d.prototype.createWrapper=
function(a){var b=$("<div></div>");b.addClass("html5-video-wrapper");b.data("status",a.data("status")||"ok");b.data("rootdir",a.data("rootdir")||"/");var c,d,e=a.data();for(c in e)e.hasOwnProperty(c)&&(d=e[c],b.data(c,d),a.removeData(c));c=$("<div></div>");c.attr("id","html5-video-holder");c.append(a);a.addClass("video-js");a.data("account","2869242976001");a.data("player","7e1cd48d-2db9-4901-acc5-63e50cdec4ca");a.data("embed","default");a.data("id","");a=$("<div></div>");a.attr("id","video-surface");
a.attr("tabindex","0");a.attr("aria-label","play");DOMUtil.isAndroidInternetBrowser()&&(a.css("background-color","transparent"),$("meta[name=viewport]").attr("content","minimum-scale=1.0,maximum-scale=1.0,user-scalable=yes"));c.append(a);d=$("<div></div>");d.attr("id","videocontrols");c.append(d);DOMUtil.isIPhone()||(d=$('<div class="spinnerwrap" id="spinner-control"> <div class="spinner spinner--indeterminate spinner--overBackground"><div class="spinner-track"></div><div class="spinner-fills"><div class="spinner-fillMask1"><div class="spinner-fillSubMask1"><div class="spinner-fill"></div></div></div><div class="spinner-fillMask2"><div class="spinner-fillSubMask2"><div class="spinner-fill"></div></div></div></div></div></div>'),
